...
public class WaitForPaymentFragment extends Fragment implements OrderAdapter.OnItemClickListener {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_wait_for_payment, container, false);
        setUpRcv(view);
        return view;
    }
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (order != null) {
                            if(!listOrderKey.contains(orderKey)
                                    && order.getStatus().equals(BasketFragment.WAIT_FOR_PAYMENT)) {
